...
=========================================================================*/
// .NAME vtkVisItTensorGlyph - scale and orient glyph(s) according to tensor eigenvalues and eigenvectors
// .SECTION Description
// vtkVisItTensorGlyph is a filter that copies a geometric representation
